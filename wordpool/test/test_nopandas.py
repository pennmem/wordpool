...
class TestConcatenateSessionLists:
    ...
    def test_assigns_listnos(self):
        ...
        assert result == [{"word": "one", "listno": 0},
                          {"word": "two", "listno": 0},
                          {"word": "three", "listno": 1},
                          {"word": "four", "listno": 1}]
...
class TestIntegratedNoPandasFunctions:
    def test_fr6_wordpool(self):
        ...
        # this will take a list of dictionaries, each dictionary representing a word.
        # it will add 'listno' entries in accordance with the provided number of lists
        ...
        # next step is to assign list types.  list types proceed from baseline, to ps, and then stim
    ...
    def test_amplitude_index_assignmnt(self):
        ...
        pool = nopandas.assign_list_numbers_from_word_list(word_list, 7)
